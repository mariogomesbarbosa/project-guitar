...
export const LessonSelect: React.FC = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col p-4 sm:p-8 max-w-6xl mx-auto overflow-y-auto select-none">
      {/* Hero Welcome Banner */}
      <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-900 via-zinc-900/90 to-blue-950/40 border border-zinc-800 p-6 sm:p-8 mb-8 shadow-2xl">
      ...
      <div className="mt-8 p-4 rounded-2xl bg-zinc-900/40 border border-zinc-800/50 flex items-center justify-between text-xs text-zinc-400">
