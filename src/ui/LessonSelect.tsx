  ...
  return (
    <div className="w-full h-full overflow-y-auto select-none">
      <div className="w-full max-w-6xl mx-auto p-4 sm:p-8 flex flex-col min-h-full">
        {/* Hero Welcome Banner */}
        <div className="shrink-0 relative overflow-hidden rounded-3xl bg-gradient-to-br from-zinc-900 via-zinc-900/90 to-orange-950/25 border border-zinc-800 p-6 sm:p-8 mb-8 shadow-2xl">
          <div className="relative z-10 max-w-2xl">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-orange-500 to-rose-500 hover:from-orange-400 hover:to-rose-400 text-white font-bold text-sm transition-all shadow-lg shadow-orange-500/25 flex items-center gap-2 cursor-pointer hover:scale-105 active:scale-98"
              >
          ...
          <div className="absolute right-0 bottom-0 top-0 w-1/3 bg-gradient-to-l from-orange-600/15 via-purple-600/10 to-transparent pointer-events-none" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-8">
          {filteredLessons.map((lesson, idx) => (
            <div
              key={lesson.id}
              className="group relative flex flex-col justify-between p-5 sm:p-6 rounded-2xl bg-zinc-900/60 hover:bg-zinc-900/90 border border-zinc-800/80 hover:border-orange-500/30 transition-all duration-200 shadow-lg hover:shadow-2xl"
            >
              <div>
              ...
              <div className="pt-4 border-t border-zinc-800/60 flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-gradient-to-r from-orange-500 to-rose-500 hover:from-orange-400 hover:to-rose-400 text-white text-xs font-bold transition-all shadow-md shadow-orange-500/20 flex items-center gap-1.5 cursor-pointer hover:scale-105 active:scale-98"
                >
        ...
        <div className="shrink-0 mt-auto p-4 rounded-2xl bg-zinc-900/40 border border-zinc-800/50 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-zinc-400">
          ...
          <button
            onClick={() => setMode('tuner')}
            className="text-orange-400 hover:text-orange-300 font-medium underline cursor-pointer"
          >
